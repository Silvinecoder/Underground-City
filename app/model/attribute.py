...
class Attribute(Base): # pragma: integration
    ...
    @classmethod
    def get_or_create(cls, session, attribute_uuid, attribute_type): # pragma: integration
        try:
            attribute = session.query(Attribute).filter_by(attribute_uuid=attribute_uuid, attribute_type=attribute_type).one()
        except NoResultFound:
            attribute = Attribute(attribute_uuid=attribute_uuid, attribute_type=attribute_type)
